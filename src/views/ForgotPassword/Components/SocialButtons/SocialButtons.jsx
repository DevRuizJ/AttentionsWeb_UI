...
import { YouTube as YouTubeIcon,
  Facebook as FacebookIcon,
  Twiter as TwiterIcon,
  Linkedin as LinkedinIcon } from '../../../../assets/icons'
// import { Facebook as FacebookIcon } from '../../../../assets/icons'
// import { Twiter as TwiterIcon } from '../../../../assets/icons'
// import { Linkedin as LinkedinIcon } from '../../../../assets/icons'
    ...
    
    {
      ListRedesSociales&&ListRedesSociales.map(rs=>
          ...
          <a 
            ...
            key={rs.id}
          >
            <IconButton  className={classes.redSocialItem}   color="primary" aria-label="add">
              {rs.image}
           </IconButton>
